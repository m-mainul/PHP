...
<div class="wmd-panel">
    <form method="POST">
        ...
        Field1 <span class="required">*</span>
        <br>
        <input type="text" class="text <?php if (isset($field_one)) { if (empty($field_one)) { echo 'error';}} ?>" name="title" value="<?php if (isset($field_one)) { echo $field_one;} ?>"/>
        <br><br>

        Field2 <span class="required">*</span>
        <br>
        <input type="text" class="text <?php if (isset($field_two)) { if (empty($field_two)) { echo 'error';}} ?>" name="title" value="<?php if (isset($field_two)) { echo $field_two;} ?>"/>
        <br><br>
